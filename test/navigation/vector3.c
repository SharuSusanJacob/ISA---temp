...
// Safety epsilon for floating poiint comparisons
#define VECTOR3_EPSILON 1e-12f

//=============================================================================
// BASIC VECTOR OPERATIONS
//=============================================================================

Vector3Error_t vector3_create(Vector3_t* result, float x, float y, float z)
{
...
Vector3Error_t vector3_scale(Vector3_t* result, const Vector3_t* v, float scalar)
{
...
Vector3Error_t vector3_dot(float* result, const Vector3_t* a, const Vector3_t* b)
{
    // Parameter validation
    if ((result == NULL) || (a == NULL) || (b == NULL)) {
        return VECTOR3_ERROR_INVALID_PARAM;
...
Vector3Error_t vector3_magnitude(float* result, const Vector3_t* v)
{
    // Parameter valiation
    if ((result == NULL) || (v == NULL)) {
        return VECTOR3_ERROR_INVALID_PARAM;
