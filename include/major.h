 ...
 * acceleration command in body frame. Uses ECEF→ECI→Local frame conversion.
 *
 ...
 * @param gnss_week GPS week number for ECI conversion
 * @param tow GPS time of week in seconds for ECI conversion
 */
